...
# Gatsby Starter Portfolio: Corona

A portfolio starter for [Gatsby](https://www.gatsbyjs.org/). The target audience are designers and photographers.

[Demo Website](https://corona.lekoarts.de)

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/LeKoArts/gatsby-starter-portfolio-corona) [![Edit gatsby-starter-portfolio-corona](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/LeKoArts/gatsby-starter-portfolio-corona/tree/master/)

[![Netlify Status](https://api.netlify.com/api/v1/badges/f51f5488-aa2d-4e42-baa7-4182d9e81c2e/deploy-status)](https://app.netlify.com/sites/portfolio-corona/deploys) [![CircleCI](https://circleci.com/gh/Nosotros/gatsby-starter-portfolio-corona.svg?style=svg)](https://circleci.com/gh/Nosotros/gatsby-starter-portfolio-corona)
...
- [gatsby-starter-portfolio-emma](https://github.com/Nosotros/gatsby-starter-portfolio-emma)
- [gatsby-starter-portfolio-emilia](https://github.com/Nosotros/gatsby-starter-portfolio-emilia)
- [gatsby-starter-portfolio-bella](https://github.com/Nosotros/gatsby-starter-portfolio-bella)
- [gatsby-starter-portfolio-cara](https://github.com/Nosotros/gatsby-starter-portfolio-cara)
...
```
gatsby new project-name https://github.com/Nosotros/gatsby-starter-portfolio-corona
cd project-name
npm run develop
```
...
module.exports = {
  ...
  siteTitle: 'Corona', // Navigation and Site Title
  siteTitleAlt: 'Corona - Gatsby Starter Portfolio', // Alternative Site title for SEO
  siteTitleShort: 'Corona', // short_name for manifest
  siteHeadline: 'Come & Enjoy our excellent photos', // Headline for schema.org JSONLD
  siteUrl: 'https://corona.lekoarts.de', // Domain of your site. No trailing slash!
  siteLanguage: 'en', // Language Tag on <html> element
  siteLogo: '/logos/logo.png', // Used for SEO and manifest
  siteDescription: 'Image-heavy photography portfolio with colorful accents & great typography',
  author: 'Nosotros', // Author for schema.org JSONLD

  // siteFBAppID: '123456789', // Facebook App ID - Optional
  userTwitter: '@corona', // Twitter Username
  ogSiteName: 'corona', // Facebook Site Name
