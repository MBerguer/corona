        ...
        <Wrapper>
          <SideBarInner bg={color} as="aside" p={[6, 6, 8]}>
            ...
            >
              <Box width={['3rem', '4rem', '5rem', '6rem']}>
                <Link to="/" aria-label="Nosotros, Back to Home">
                  <Logo />
                </Link>
              </Box>
              <Nav
          ...
          <Footer color={color}>
            <Box p={[6, 6, 8]} fontSize={0}>
              Financia <a href="https://www.csic.edu.uy/">CSIC</a>.<br />
              <a href="https://github.com/Nosotros/gatsby-starter-portfolio-corona">desarrollado con Gatsby</a>.
            </Box>
          </Footer>
        </Wrapper>
      </>
